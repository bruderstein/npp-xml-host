...
describe('ValidatePlugin', function () {
    ...
    beforeEach(function (done) {
        ...
        console.log('Creating and writing to', tempDir);
    ...
    afterEach(function (done) {
        ...
        console.log('removing validate temp', tempDir)
    ...
    describe('after update to validate.json', function () {
        ...
        beforeEach(function () {
            ...
            return Fs.unlinkAsync(Path.join(tempDir, 'validate.json'))
                .then(function () {
                    console.log('about to write validate.json', tempDir)
                    return Fs.writeFileAsync(Path.join(tempDir, 'validate.json'),
                        JSON.stringify({
                    ...
                    return new Promise(function (resolve, reject) {
                        server.plugins['nppxmlhost-validate-plugin'].events.on('changed', resolve);
                    });
                });
        });
