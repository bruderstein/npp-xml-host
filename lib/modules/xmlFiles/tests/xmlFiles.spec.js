...
describe('XmlFiles', function () {
    ...
    afterEach(function (done) {
        ...
        server.plugins['nppxmlhost-xmlfiles-plugin'].watcher.close();
    ...
    it('returns a 304 Not Modified when If-Modified-Since is set', function () {
    ...
    it('returns a 304 Not Modified when If-None-Match is set', function () {
        var etag;
        return inject({
            method: 'get',
            url: '/pm/xml/file1.zip'
